/* NanoHive ABS — JS Enhancements  v6.175.0  (injected build) */
...
(function () {
  ...
  function createCustomizationsPanel(configPage, hideBranding = false, isConfigPage = false) {
    ...
    panel.innerHTML = `
      ...
      <div class="nh-grid">
        ...
        <section class="nh-card">
          ...
          <div class="nh-field" id="nh-tog-ratefinished"></div>
    ...
    // Deliberately NOT in the "Hide Homepage Shelves" group below. Every toggle
    // there is a hide* key where ON means hidden; this one is a show* key where
    // ON means shown, so sitting among them it read as inverted — people turned
    // it on to hide the row and got the opposite. Same polarity as its
    // neighbours here (carousel, series cards): on = you get it.
    panel.querySelector('#nh-tog-ratefinished').appendChild(createToggle(T.rfToggle || PANEL_T.en.rfToggle, 'showRateFinished'));
